...
namespace DovotosTool
{
    public class CPU_6502
    {
        ...
        public static RingBuffer<int> CallStack = new RingBuffer<int>(20);
        public static RingBuffer<int> PCStack = new RingBuffer<int>(20);
        ...
        public struct Opcode
        {
            ...
            public static int Operand(AddressingMode addressMode)
            {
                ...
                switch (addressMode)
                {
                    ...
                    case AddressingMode.IndirectY:
                        int zpAddressY = (GameState.Cart.CPURead(GameState.CPU.PC + 1) & 0xFF);
                        return GameState.Cart.CPURead((GameState.Cart.CPURead(zpAddressY) | (GameState.Cart.CPURead((zpAddressY + 1) & 0xFF) << 8)) + GameState.CPU.Y);
            ...
            public static void Store(AddressingMode addressMode, byte d)
            {
                ...
                switch (addressMode)
                {
                    ...
                    case AddressingMode.IndirectX:
                        ...
                        return;
                    case AddressingMode.IndirectY:
                        int zpAddressY = (GameState.Cart.CPURead(GameState.CPU.PC + 1));
                        GameState.Cart.CPUWrite(d, (GameState.Cart.CPURead(zpAddressY) | (GameState.Cart.CPURead((zpAddressY + 1) & 0xFF) << 8)) + GameState.CPU.Y);
                        return;
                    case AddressingMode.ZeroPage:
                        GameState.Cart.CPUWrite(d, (GameState.Cart.CPURead(GameState.CPU.PC + 1)));
                        return;
            ...
            {
                int o = Operand(op.addressMode) - 1;
                Store(op.addressMode, (byte)(o));
            ...
            {
                int addr = GameState.Cart.CPURead(GameState.CPU.PC + 1) | (GameState.Cart.CPURead(GameState.CPU.PC + 2) << 8);
                ...
                CallStack.Add(GameState.CPU.PC);
    ...
    public class RingBuffer<T>
    {
        ...
        public T[] GetRing()
        {
            ...
            {
                temp[i] = buffer[ptr - 1 - i >= 0 ? ptr - 1 - i : ptr - 1 - i + buffer.Length];
            }
