 ...
 //Math
  ...
  //Storage      
        ...
        public static Opcode[] Opcodes = {
          //0x00
            new Opcode("BRK",AddressingMode.Immediate,7,false, ORA ),
            new Opcode("ORA",AddressingMode.IndirectX, 6, false, ORA),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("ORA",AddressingMode.ZeroPage, 3, false, ORA),
            new Opcode("ASL",AddressingMode.ZeroPage, 5, false, ASL),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("PHP",AddressingMode.Implicit, 3, false, PHP),
            new Opcode("ORA",AddressingMode.Immediate, 2, false, ORA),
            new Opcode("ASL",AddressingMode.Accumulator, 2, false, ASL),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("ORA",AddressingMode.Absolute, 4, false, ORA),
            new Opcode("ASL",AddressingMode.Absolute, 6, false, ASL),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
          //0x10
            new Opcode("BPL",AddressingMode.Immediate, 2, false, BPL),
            new Opcode("ORA",AddressingMode.IndirectY, 5, false, ORA),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
          ...
          //0x20
            ...
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("BIT",AddressingMode.ZeroPage, 3, false, BIT),
            new Opcode("AND",AddressingMode.ZeroPage, 3, false, AND),
            new Opcode("ROL",AddressingMode.ZeroPage, 5, false, ROL),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("PLP",AddressingMode.Implicit, 4, false, PLP),
            new Opcode("AND",AddressingMode.Immediate, 2, false, AND),
            new Opcode("ROL",AddressingMode.Accumulator, 2, false, ROL),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("BIT",AddressingMode.Absolute, 4, false, BIT),
            new Opcode("AND",AddressingMode.Absolute, 4, false, AND),
            new Opcode("ROL",AddressingMode.Absolute, 6, false, ROL),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
          //0x30
            new Opcode("BMI",AddressingMode.Immediate, 2, false, BMI),
            new Opcode("AND",AddressingMode.IndirectY, 5, false, AND),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("AND",AddressingMode.ZeroPageX, 4, false, AND),
            new Opcode("ROL",AddressingMode.ZeroPageX, 6, false, ROL),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("SEC",AddressingMode.Implicit, 2, false, delegate(Opcode op){GameState.CPU.C = true;  return op.cycles;}),
            new Opcode("AND",AddressingMode.AbsoluteY, 4, false, AND),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("AND",AddressingMode.AbsoluteX, 4, false, AND),
            new Opcode("ROL",AddressingMode.AbsoluteX, 7, false, ROL),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
          //0x40
            new Opcode("RTI",AddressingMode.Implicit, 6, false, RTI),
            new Opcode("EOR",AddressingMode.IndirectX, 6, false, EOR),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("EOR",AddressingMode.ZeroPage, 3, false, EOR),
            new Opcode("LSR",AddressingMode.ZeroPage, 5, false, LSR),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("PHA",AddressingMode.Implicit, 3, false, PHA),
            new Opcode("EOR",AddressingMode.Immediate, 2, false, EOR),
            new Opcode("LSR",AddressingMode.Accumulator, 2, false, LSR),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("JMP",AddressingMode.Absolute, 3, false, JMP),
            new Opcode("EOR",AddressingMode.Absolute, 4, false, EOR),
            new Opcode("LSR",AddressingMode.Absolute, 6, false, LSR),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
          //0x50
            ...
            new Opcode("LSR",AddressingMode.ZeroPageX, 6, false, LSR),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            ...
            new Opcode("LSR",AddressingMode.AbsoluteX, 7, false, LSR),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
          //0x60
            new Opcode("RTS",AddressingMode.Implicit, 6, false, RTS),
            new Opcode("ADC",AddressingMode.IndirectX, 6, false, ADC),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("ADC",AddressingMode.ZeroPage, 3, false, ADC),
            new Opcode("ROR",AddressingMode.ZeroPage, 5, false, ROR),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("PLA",AddressingMode.Implicit, 4, false, PLA),
            new Opcode("ADC",AddressingMode.Immediate, 2, false, ADC),
            new Opcode("ROR",AddressingMode.Accumulator, 2, false, ROR),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("JMP",AddressingMode.Indirect, 6, false, JMP),
            new Opcode("ADC",AddressingMode.Absolute, 4, false, ADC),
            new Opcode("ROR",AddressingMode.Absolute, 6, false, ROR),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
          //0x70
            new Opcode("BVS",AddressingMode.Immediate, 2, false, BVS),
            new Opcode("ADC",AddressingMode.IndirectY, 5, false, ADC),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("ADC",AddressingMode.ZeroPageX, 4, false, ADC),
            new Opcode("ROR",AddressingMode.ZeroPageX, 6, false, ROR),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("SEI",AddressingMode.Implicit, s, false, delegate(Opcode op){GameState.CPU.I = true;  return op.cycles;}),
            new Opcode("ADC",AddressingMode.AbsoluteY, 4, false, ADC),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("ADC",AddressingMode.AbsoluteX, 4, false, ADC),
            new Opcode("ROR",AddressingMode.AbsoluteX, 7, false, ROR),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
          //0x80
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("STA",AddressingMode.IndirectX, 6, false, STA),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("STY",AddressingMode.ZeroPage, 3, false, STY),
            new Opcode("STA",AddressingMode.ZeroPage, 3, false, STA),
            new Opcode("STX",AddressingMode.ZeroPage, 3, false, STX),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("DEY",AddressingMode.Implicit, 2, false, DEY),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("TXA",AddressingMode.Implicit, 2, false, TXA),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            ...
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
          //0x90
            new Opcode("BCC",AddressingMode.Immediate, 2, false, BCC),
            new Opcode("STA",AddressingMode.IndirectY, 6, false, STA),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            ...
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("TYA",AddressingMode.Implicit, 2, false, TYA),
            new Opcode("STA",AddressingMode.AbsoluteY, 5, false, STA),
            new Opcode("TXS",AddressingMode.Implicit, 2, false, TXS),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("STA",AddressingMode.AbsoluteX, 5, false, STA),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
          //0xA0
            new Opcode("LDY",AddressingMode.Immediate, 2, false, LDY),
            new Opcode("LDA",AddressingMode.IndirectX, 6, false, LDA),
            new Opcode("LDX",AddressingMode.Immediate, 2, false, LDX),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("LDY",AddressingMode.ZeroPage, 3, false, LDY),
            new Opcode("LDA",AddressingMode.ZeroPage, 3, false, LDA),
            new Opcode("LDX",AddressingMode.ZeroPage, 3, false, LDX),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("TAY",AddressingMode.Implicit, 2, false, TAY),
            new Opcode("LDA",AddressingMode.Immediate, 2, false, LDA),
            new Opcode("TAX",AddressingMode.Implicit, 2, false, TAX),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("LDY",AddressingMode.Absolute, 4, false, LDY),
            new Opcode("LDA",AddressingMode.Absolute, , false, LDA),
            new Opcode("LDX",AddressingMode.Absolute, 4, false, LDX),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
          //0xB0
            new Opcode("BCS",AddressingMode.Immediate, 2, false, BCS),
            new Opcode("LDA",AddressingMode.IndirectY, 5, false, LDA),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            ...
            new Opcode("LDA",AddressingMode.AbsoluteY, 2, false, LDA),
          ...
          //0xE0
            ...
            new Opcode("SBC",AddressingMode.IndirectX, 6, false, SBC),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("CPX",AddressingMode.ZeroPage, 3, false, CPX),
            new Opcode("SBC",AddressingMode.ZeroPage, 3, false, SBC),
            new Opcode("INC",AddressingMode.ZeroPage, 5, false, INC),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("INX",AddressingMode.Implicit, 2, false, INX),
            new Opcode("SBC",AddressingMode.Immediate, 2, false, SBC),
            new Opcode("NOP",AddressingMode.Implicit, 2, false, delegate(Opcode op){return op.cycles;}),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            ...
            new Opcode("SBC",AddressingMode.IndirectY, 5, false, SBC),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            ...
            new Opcode("invalid",AddressingMode.Implicit, 4, false, Invalid),
            new Opcode("SED",AddressingMode.Implicit, 2, false, delegate(Opcode op){GameState.CPU.D = true;  return op.cycles;}),
